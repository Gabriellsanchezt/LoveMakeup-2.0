  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Marca</li>
      </ol>
...
<div class="container-fluid py-4"> <!-- DIV CONTENIDO -->
    ...
    <!--Titulo de página -->
     <div class="d-sm-flex align-items-center justify-content-between mb-3">
       <h4 class="mb-0 texto-quinto"><i class="fa-solid fa-certificate me-2" style="color: #f6c5b4;"></i>
        Marca</h4>
           
        <div class="d-flex gap-2">
      <?php if ($_SESSION["nivel_rol"] >= 2 && tieneAcceso(8, 'registrar')): ?>
